...
echo "<H1>seedBlogs Demo Site database setup</H1>\n";
...
echo "Creating table <B>$tableName</B><BR>\n";
...
echo "Populating table <B>$tableName</B><BR>\n";
...
sb_queryDatabase( "INSERT INTO $tableName VALUES
...
echo "<BR><BR> ".
     "You can now log-in to the demo site with the following account:<BR>\n";

echo "Login: <B>test</B><BR>\n";
echo "Password: <B>test</B><BR><BR>\n";

echo "Click <A HREF=\"index.php\">here</A> to go to the demo site.";
